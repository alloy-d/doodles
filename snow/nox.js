if (Browser.chrome || Browser.safari) {
    document.addEvent('domready', function () {
        ...
        var resizeCanvas = function () {
            ...
            gradient.addColorStop(0.9, "#111815");
            gradient.addColorStop(1.0, "#111815");
        }
        ...
        var drawCanvas = function () {
            ...
            context.beginPath();
            context.moveTo(cw(843), ch(196));
            context.lineTo(cw(857), ch(196));
            context.lineTo(cw(857), ch(1000));
            context.lineTo(cw(843), ch(1000));
            context.lineTo(cw(843), ch(196));
            context.fill();
            context.closePath();
        ...
        setInterval(function(){clearCanvas();drawCanvas()}, 60);
    });
}
